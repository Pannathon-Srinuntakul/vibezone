...
const FluffyPre = ({ date, post, likesCount, creator, details }) => {
    ...
    <div className="fixed inset-0 bg-green-1 z-30 overflow-auto">
      ...
      <div className="preview-container">
        <div className="flex flex-col items-center w-full">
          <div className="flex flex-col w-5/6 md:w-1/2 lg:w-1/3">
            <div className="p-8 pb-20 relative shadow-lg z-50 overflow-hidden bg-[#E9E0F5]">
              ...
              <div className="w-full md:min-h-[200px] xl:min-h-[300px] flex items-center pb-8 relative">
                <Image
                  ...
                  className="absolute -bottom-4 left-2 w-[170px] -z-10"
                  width={200}
                  height={50}
                  alt="icon"
                />
                <Image
                  ...
                  className="absolute -bottom-10 -right-7 w-[100px] -z-10"
                  width={200}
                  height={50}
                  alt="icon"
                />
                <Image
                  ...
                  className="absolute top-24 -right-3 w-[30px] -z-10"
                  width={200}
                  height={50}
                  alt="icon"
                />
                <Image
                  ...
                  className="absolute bottom-20 -left-2 w-[30px] -z-10"
                  width={200}
                  height={50}
                  alt="icon"
                />
                <Image
                  ...
                  className="absolute top-1 -left-3 w-[30px] --z-10"
                  width={200}
                  height={50}
                  alt="icon"
                />
            ...
            {isExpand ? (
              <div className="p-5 sm:p-7 md:p-7 lg:p-6 flex flex-col gap-3 bg-[#F3EEF9] shadow-lg">
      ...
      <div className="w-full h-full absolute -top-[9999999px] -right-[99999999px] flex justify-center items-center py-10">
        <div className="mt-96">
          ...
          >
            <div className="bg-[#E9E0F5] frame-container pb-10">
              ...
              <div className="relative">
                <img
                  src="/framecom/fluffy/fluffy.png"
                  className="absolute -bottom-12 left-6 w-[480px] z-10"
                  width={200}
                  height={50}
                  alt="icon"
                />
                <img
                  src="/framecom/fluffy/lily.png"
                  className="absolute -bottom-10 -right-7 w-[220px] z-10"
                  width={200}
                  height={50}
                  alt="icon"
                />
                <img
                  src="/framecom/fluffy/dec1.png"
                  className="absolute top-52 -right-8 w-[80px] z-10"
                  width={200}
                  height={50}
                  alt="icon"
                />
                <img
                  src="/framecom/fluffy/dec2.png"
                  className="absolute bottom-60 -left-5 w-[80px] z-10"
                  width={200}
                  height={50}
                  alt="icon"
                />
                <img
                  src="/framecom/fluffy/dec3.png"
                  className="absolute top-5 -left-8 w-[80px] z-10"
                  width={200}
                  height={50}
                  alt="icon"
                />
              ...
              {showLikes ? (
                <p className="text-black text-[20px] flex justify-center items-center gap-1 z-20 mt-10">
            ...
            {isExpand ? (
              <div className="p-10 flex flex-col gap-8 bg-[#F3EEF9] shadow-lg">
                <div className="w-full">
                  <div className="flex justify-between">
                    {showProfile ? (
