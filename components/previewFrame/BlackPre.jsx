...
const BlackPre = ({ date, post, likesCount, creator, details }) => {
      ...
      <div className="fixed inset-0 bg-green-1 z-30 overflow-auto">
        ...
        <div className="preview-container">
          <div className="flex flex-col items-center w-full">
            <div className="flex flex-col w-5/6 md:w-1/2 lg:w-1/3">
              <div className="p-8 pb-20 relative shadow-lg z-50 overflow-hidden bg-[#1D1C1A]">
                ...
                {!isExpand ? (
                  ...
                  >
                    <ExpandMoreOutlined sx={{ cursor: "pointer", color: "white" }} />
                  </div>
                ) : (
                  <div
                    id="expandBtn"
                  ...
                  >
                    <ExpandLessOutlined sx={{ cursor: "pointer", color: "white" }} />
                  </div>
                )}
                {showLikes ? (
                  <VisibilityOff
              ...
              {isExpand ? (
                <div className="p-5 sm:p-7 md:p-7 lg:p-6 flex flex-col gap-3 bg-[#333230] shadow-lg">
                  ...
                  <div className="w-full flex flex-col justify-center items-center">
                    <p className="text-base-bold text-white">{post.caption}</p>
                    <p className="border border-subtext/30 font-thin w-full"></p>
                  </div>
                  <div className="details">
                    {details.map((detail, index) => (
                      <div key={index}>
                        <p className="text-subtle-medium text-white md:text-small-semibold break-words whitespace-normal">
                          {detail}
                        </p>
                      </div>
                    ))}
        ...
        <div className="w-full h-full absolute -top-[9999999px] -right-[99999999px] flex justify-center items-center py-10">
          <div className="mt-96">
            ...
            >
              <div className="bg-[#1D1C1A] frame-container">
                ...
                {showLikes ? (
                  <p className="text-white text-[20px] flex justify-center items-center gap-1">
                    ...
                    {likesCount.toLocaleString()}{" "}
                    <span className="text-white text-[15px]">Like</span>
                  </p>
                ) : null}
              </div>
              {isExpand ? (
                <div className="p-10 flex flex-col gap-8 bg-[#333230] shadow-lg">
                  <div className="w-full">
                    <div className="flex justify-between">
                      {showProfile ? (
                  ...
                  <div className="w-full flex flex-col justify-center items-center">
                    <p className="text-[34px] text-white font-bold">{post.caption}</p>
                    <p className="border border-subtext/75 font-thin w-full"></p>
                  </div>
                  <div className="flex text-white flex-col gap-8 pl-4 justify-start">
                    {details.map((detail, index) => (
                      <div key={index}>
                        <p className="text-[22px] text-white break-words whitespace-normal">
                          {detail}
                        </p>
                      </div>
                    ))}
