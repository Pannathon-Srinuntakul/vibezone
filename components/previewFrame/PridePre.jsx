...
const PridePre = ({ date, post, likesCount, creator, details }) => {
      ...
      <div className="fixed inset-0 bg-green-1 z-30 overflow-auto">
        ...
        <div className="preview-container">
          <div className="flex flex-col items-center w-full">
            <div className="flex flex-col w-5/6 md:w-1/2 lg:w-1/3">
              <div className="p-8 pb-20 relative shadow-lg z-50 overflow-hidden bg-pride-gradient">
              ...
              {isExpand ? (
                <div className="p-5 sm:p-7 md:p-7 lg:p-6 flex flex-col gap-3 bg-[#FFCCE5] shadow-lg">
        ...
        <div className="w-full h-full absolute -top-[9999999px] -right-[99999999px] flex justify-center items-center py-10">
          <div className="mt-96">
            ...
            >
              <div className="bg-pride-gradient frame-container">
              ...
              {isExpand ? (
                <div className="p-10 flex flex-col gap-8 bg-[#FFCCE5] shadow-lg">
                  <div className="w-full">
                    <div className="flex justify-between">
                      {showProfile ? (
