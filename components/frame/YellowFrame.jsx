...
const YellowFrame = ({
  ...
  return (
    <div className="w-full flex flex-col items-center justify-center">
      ...
      {isExpand ? (
        <div className="card-container gap-3 rounded-b-xl bg-[#edea89] shadow-lg">
        ...
        <div className="fixed inset-0 bg-green-1 z-30 overflow-auto">
          ...
          <div className="w-full h-full absolute -top-[9999999px] -right-[99999999px] py-10 overflow-hidden">
            <div className="mt-96">
              ...
              >
                <div className="p-28 pb-44 bg-[#F3F0A8] flex flex-col justify-center items-center relative shadow-lg z-10">
                ...
                {isExpand ? (
                  <div className="p-28 flex flex-col gap-8 bg-[#edea89] shadow-lg">
                    <div className="w-full">
                      <div className="flex justify-between">
                        {showProfile ? (
