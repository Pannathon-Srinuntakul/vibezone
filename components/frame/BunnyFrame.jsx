...
const BunnyFrame = ({ post, creator, loggedInUser, updateUser }) => {
  ...
  return !isDeleted ? (
    <div className="w-full flex flex-col items-center justify-center">
      <div className="card-container bg-white shadow-lg overflow-hidden z-10">
        ...
        >
          <Image
            ...
            className="absolute -bottom-12 -left-3 w-[140px] z-10"
            width={200}
            height={50}
            alt="icon"
          />
          <Image
            ...
            className="absolute -bottom-6 -right-4 w-[140px] z-10"
            width={200}
            height={50}
            alt="icon"
          />
          <Image
            ...
            className="absolute top-20 -right-4 w-[65px] z-10"
            width={200}
            height={50}
            alt="icon"
          />
          ...
          <Image
            ...
            className="absolute -right-2 bottom-24 w-[40px] z-10"
            width={200}
            height={50}
            alt="icon"
          />
