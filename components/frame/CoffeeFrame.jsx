...
const CoffeeFrame = ({ post, creator, loggedInUser, updateUser }) => {
  ...
  return !isDeleted ? (
    <div className="w-full flex flex-col items-center justify-center">
      <div className="card-container bg-[#F6EEE3] shadow-lg overflow-hidden z-10">
        ...
        >
          <Image
            ...
            className="absolute -bottom-9 -left-3 w-[100px] z-10"
            width={200}
            height={50}
            alt="icon"
          />
          <Image
            ...
            className="absolute -bottom-9 -right-3 w-[150px] z-10"
            width={200}
            height={50}
            alt="icon"
          />
      ...
      {isExpand ? (
        <div className="card-container gap-3 rounded-b-xl bg-[#FBF3E8] shadow-lg">
