...
const BlackFrame = ({ post, creator, loggedInUser, updateUser }) => {
  ...
  return !isDeleted ? (
    <div className="w-full flex flex-col items-center justify-center">
      <div className="card-container bg-[#1D1C1A] shadow-lg overflow-hidden z-10">
      ...
      {isExpand ? (
        <div className="card-container gap-3 rounded-b-xl bg-[#333230] shadow-lg">
          ...
          <div className="details">
            {details.map((detail, index) => (
              <ul key={index}>
                <li className="text-subtle-medium text-white md:text-small-semibold break-words whitespace-normal">
                  {detail}
                </li>
              </ul>
            ))}
